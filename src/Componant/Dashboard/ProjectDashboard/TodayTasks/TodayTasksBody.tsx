        ...
        <LI className="bg-light" key={i}>
          ...
          <div className="d-flex align-items-center gap-2">
            <div className="flex-shrink-0">
              {!data.img1 ? (
                <Image
                  src={`/src/assets/images/dashboard-2/user/${data.img}`}
                  alt="user"
                />
              ) : (
                <div className="customers social-group">
                  <UL className="simple-list flex-row">
                    <LI className="d-inline-block">
                      <Image className="rounded-circle border-0" src={`/src/assets/images/dashboard-2/user/${data.img}`} alt="users" />
                    </LI>
                    <LI className="d-inline-block">
                      <Image className="rounded-circle" src={`/src/assets/images/dashboard-2/user/${data.img1}`} alt="users" />
                    </LI>
                  </UL>
                </div>
              )}
