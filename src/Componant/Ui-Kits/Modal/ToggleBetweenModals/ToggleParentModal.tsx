    ...
    return (
      <div className="modal-toggle-wrapper">
        <UL className="modal-img simple-list flex-row">
          <LI><Image src={"/src/assets/images/gif/whatapp.gif"} alt="whatsapp" /></LI>
          <LI><Image src={"/src/assets/images/gif/instagram.gif"} alt="instagram" /></LI>
          <LI><Image src={"/src/assets/images/gif/facebook.gif"} alt="facebook" /></LI>
        </UL>
