        ...
        <CardBody className="avatar-showcase">
          <div className="avatars">
            <div className="avatar ratio">
              <Image width={100} height={100} className="b-r-8 img-100" src={"/src/assets/images/avtar/11.jpg"} alt="image" />
            </div>
            {ratios.map(({ className, src ,size}, index) => (
              <div className="avatar ratio" key={index}>
                <Image width={size} height={size} className={`b-r-8 ${className}`} src={`/src/assets/images/${src}`} alt="image" />
              </div>
            ))}
          </div>
        </CardBody>
