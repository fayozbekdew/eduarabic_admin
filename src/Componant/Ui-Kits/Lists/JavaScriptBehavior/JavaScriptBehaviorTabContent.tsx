        ...
        <TabPane tabId="1">
          <div className="d-flex mb-xl-4 list-behavior-1">
            <div className="flex-shrink-0">
              <Image className="tab-img img-fluid" src={"/src/assets/images/blog/img.png"} alt="home"/>
            </div>
          ...
          <div className="d-xl-flex list-behavior-2">
            ...
            <div className="flex-shrink-0">
              <Image className="tab-img img-fluid" src={"/src/assets/images/blog/blog.jpg"} alt="home"/>
            </div>
          </div>
        </TabPane>
        <TabPane tabId="2" className="dark-list">
          <div className="flex-space align-items-center list-light-dark contact-profile">
            <Image className="tab-img" src={"/src/assets/images/avtar/3.jpg"} alt="profile"/>
