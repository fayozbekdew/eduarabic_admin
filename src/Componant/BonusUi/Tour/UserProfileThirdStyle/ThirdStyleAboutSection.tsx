        ...
        <Col sm="6">
          <Link to={Href}>
            <div className="tour-blog">
              <Image className="img-fluid rounded" src={`/src/assets/images/other-images/mountain.jpg`} alt="mountain" />
            </div>
          </Link>
        </Col>
        <Col sm="6">
          <Link to={Href}>
            <div className="tour-blog">
              <Image className="img-fluid rounded" src={`/src/assets/images/other-images/sea.jpg`} alt="sea" />
            </div>
          </Link>
        </Col>
      </Row>
