    ...
    <div className='customers'>
        <UL className='simple-list' >
            <LI className='d-inline-block border-0' >
                <Image className='img-30 rounded-circle' src={`/src/assets/images/user/${item.customers_image1}`} alt='user' />
            </LI>
            <LI className='d-inline-block border-0' >
                <Image className='img-30 rounded-circle' src={`/src/assets/images/user/${item.customers_image2}`} alt='user' />
            </LI>
            <LI className='d-inline-block border-0' >
                <Image className='img-30 rounded-circle' src={`/src/assets/images/user/${item.customers_image3}`} alt='user' />
            </LI>
