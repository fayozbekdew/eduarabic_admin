          ...
          <Row className="g-3 mt-4 pictures">
            <Col sm="6">
              <div className="tour-blog">
                <Image className="img-fluid rounded" src={"/src/assets/images/other-images/profile-style-img3.png"} alt="mountain" />
              </div>
            </Col>
            <Col sm="6">
              <div className="tour-blog">
                <Image className="img-fluid rounded" src={"/src/assets/images/other-images/profile-style-img.png"} alt="sea" />
              </div>
            </Col>
          </Row>
