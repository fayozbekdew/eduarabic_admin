    ...
    <Collapse isOpen={isFilter}>
      <CardBody className="socialprofile filter-cards-view">
        <div className="d-flex">
          <Image className="img-50 img-fluid m-r-20 rounded-circle" src={'/src/assets/images/user/1.jpg'} alt="user"/>
        ...
        <Image className= "img-fluid mt-5" alt= "timeline-image" src= {"/src/assets/images/social-app/timeline-3.png"}  /> 
      </CardBody>
    </Collapse>
  )
}
