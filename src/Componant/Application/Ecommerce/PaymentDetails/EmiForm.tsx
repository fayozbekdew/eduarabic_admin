              ...
              <FormGroup>
                <Col xs="12">
                  <UL className="payment-opt simple-list flex-row">
                    <LI><Image src={`/src/assets/images/ecommerce/mastercard.png`} alt="mastercard" /></LI>
                    <LI><Image src={`/src/assets/images/ecommerce/visa.png`} alt="visa" /></LI>
                    <LI><Image src={`/src/assets/images/ecommerce/paypal.png`} alt="paypal" /></LI>
                  </UL>
                </Col>
              </FormGroup>
              <Col xs="12">
