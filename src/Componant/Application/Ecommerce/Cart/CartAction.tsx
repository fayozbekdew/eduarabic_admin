      ...
      <>
        ...
        <tr>
          <td className="text-end" colSpan={5}>
            <Link to={`/ecommerce/products`} className="btn btn-secondary cart-btn-transform">{ContinueShopping}</Link>
          </td>
          <td>
            <Link className="btn btn-success cart-btn-transform" to={`/ecommerce/checkout`}>{Checkout}</Link>
          </td>
        </tr>
      </>
    )
