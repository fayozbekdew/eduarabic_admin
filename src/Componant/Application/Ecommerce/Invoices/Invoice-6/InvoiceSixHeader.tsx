        ...
        <Col sm="6">
          <div className="d-flex">
            <div className="media-left">
              <Image className="media-object img-60 for-light" src={"/src/assets/images/other-images/logo-login.png"} alt="logo" />
              <Image className="media-object img-60 for-dark" src={"/src/assets/images/other-images/logo-light.png"} alt="logo" />
            </div>
