...
const InvoiceRightLogo = () => {
  return (
    <td>
      <Image className="img-fluid for-light" src={"/src/assets/images/logo/logo.png"} alt="logo" style={{ marginBottom: 14 }} />
      <Image className="img-fluid for-dark" src={"/src/assets/images/logo/logo_light.png"} alt="logo" style={{ marginBottom: 14 }} />
