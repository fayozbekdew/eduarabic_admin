import { Col, Form, FormGroup, Input, Label, Row,Container, Card, CardBody } from "reactstrap";
import { Typeahead } from "react-bootstrap-typeahead";
import { useEffect, useState } from "react";
import { toast } from "react-toastify";
import CardHeaderCommon from "../../../CommonElements/CardHeaderCommon/CardHeaderCommon";
const AddOnlySectionForm: React.FC = () => {
    ...
    <Container fluid>
      <Row>
        <Col xl="12">
          <Card className="">
            <CardHeaderCommon
              title={"Bo'lim malumotlarini kiriting"}
            />
...
export default AddOnlySectionForm;
