...
const routes = [
  ...
  { path: `/uikits/grid`, Component: <Grid /> },
  {
    path: `/uikits/tagpills`,
    Component: <TagAndPills />,
  },
  {
    path: `/uikits/progress`,
    Component: <Progress />,
  },
  { path: `/uikits/modal`, Component: <Modal /> },
  { path: `/uikits/alert`, Component: <Alert /> },
  {
    path: `/uikits/popover`,
    Component: <Popover />,
  },
  ...
  { path: `/uikits/list`, Component: <Lists /> },

  // Bonus-Ui
  {
    path: `/bonusui/scrollable`,
    Component: <Scrollable />,
  },
  {
    path: `/bonusui/tree_view`,
    Component: <TreeView />,
  },
  {
    path: `/bonusui/toasts`,
  ...
  {
    path: `/bonusui/dropzone`,
    Component: <Dropzone />,
  },
  { path: `/bonusui/tour`, Component: <Tour /> },
  {
    path: `/bonusui/sweet_alert2`,
  ...
  {
    path: `/bonusui/ribbons`,
    Component: <Ribbons />,
  },
  {
    path: `/bonusui/pagination`,
    Component: <Paginations />,
  },
  {
    path: `/bonusui/breadcrumb`,
    Component: <Breadcrumb />,
  },
  {
    path: `/bonusui/range_slider`,
  ...
  {
    path: `/buttons/flat_style`,
    Component: <FlatStyle />,
  },
  {
    path: `/buttons/edge_style`,
    Component: <EdgeStyle />,
  },
  {
  ...
  // Charts
  {
    path: `/charts/apex_chart`,
    Component: <ApexChart />,
  },
  {
    path: `/charts/google_chart`,
